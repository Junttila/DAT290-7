...
% ny
Syftet med detta projekt är att uppdatera den klassiska radiostyrda bilen med hjälp av ny teknik som bluetooth. För att följaktligen erhålla en mer modern teknisk produkt.   % detta är ett försag på att lösa vad "ny teknik" syftar på
...
% ändringar geom förda. tog bort stycket under och samanfogade dem till ett störe.
...
% vill bara ha dutycycles. kan man skriva in den i orlistan?
