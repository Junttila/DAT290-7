...
\section{Bakgrund}
%Den hårdvara som tillhandahålls är radiobil, handkontroll(sändare) och signalomvandlare(mottagare). Radiosignaler på okänd frekvens skickas från handkontrollen och avkodas av mottagaren i radiobilen. Därefter omvandlas radiosignalerna till elektroniska signaler genom mottagaren som kontrollerar antingen bilens hastighet eller riktning. Bilens hastighet kontrolleras analogt av motorns kraftutslag, medan riktningen beror av hjulens gradförskjutning. Genom en yttterligare signal kan bilens hastighet reverseras. Elektroniska signaler
...
%Vad används potentiometer till?
...
%Bluetooth protokoll på liknande men utökat? Hur? Systemöversikt?
